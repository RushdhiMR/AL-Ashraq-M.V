...
// Set project root URL path (update if your folder is renamed)
$root = '/school/';
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        ...
        <nav class="main-nav" id="mainNav">
            <ul>
                ...
                <li><a href="<?php echo $root; ?>admin/dashboard.php" class="<?php echo $current_page==='admin/dashboard.php'?'active':''; ?>">Admin Dashboard</a></li>
                <?php endif; ?>
            </ul>
        </nav>
    </div>
