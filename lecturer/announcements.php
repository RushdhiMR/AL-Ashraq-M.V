<?php
// ============================================================
// lecturer/announcements.php — All Announcements
// ============================================================
...
<div class="prt-panel">
    <div class="prt-panel-head">
        ...
        <form method="GET" style="display:flex;gap:8px;align-items:center;">
            <input class="prt-input prt-input-sm" type="text" name="search" placeholder="Search announcements…" value="<?php echo htmlspecialchars($search); ?>" style="min-width:220px;padding:7px 12px;">
            <button type="submit" class="prt-btn prt-btn-primary prt-btn-sm"><i class="fas fa-search"></i></button>
            <?php if ($search): ?><a href="announcements.php" class="prt-btn prt-btn-ghost prt-btn-sm"><i class="fas fa-times"></i></a><?php endif; ?>
        </form>
    </div>
    <div class="prt-panel-body">
        ...
        <div class="empty-state">
            ...
            <?php if ($search): ?><a href="announcements.php" class="prt-btn prt-btn-ghost prt-btn-sm" style="margin-top:10px;"><i class="fas fa-times"></i> Clear Search</a><?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
</div>
