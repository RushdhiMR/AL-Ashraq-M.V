<?php
// ============================================================
// lecturer/profile.php — Lecturer Portal Profile
// ============================================================
                ...
                <div class="prt-panel-body">
                    ...
                    <div class="prt-form-row">
                        ...
                        <div class="prt-form-group">
                            ...
                            <input class="prt-input" type="text" name="class_grade" value="<?php echo htmlspecialchars($user['class_grade']); ?>">
                        </div>
                        <?php else: ?>
                        <div class="prt-form-group">
                    ...
                    <div class="prt-form-row">
                        <div class="prt-form-group">
                            ...
                            <input class="prt-input" type="text" name="gender" value="<?php echo htmlspecialchars($user['gender']); ?>">
                        </div>
                        <div class="prt-form-group">
                            <label class="prt-label">Date of Birth</label>
                            <input class="prt-input" type="date" name="dob" value="<?php echo htmlspecialchars($user['dob']); ?>">
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="prt-form-group">
                        <label class="prt-label">Address</label>
                        <textarea class="prt-textarea" name="address"><?php echo htmlspecialchars($user['address']); ?></textarea>
                    </div>
                    <div class="prt-form-row">
                        <div class="prt-form-group">
                            <label class="prt-label">New Password</label>
                            <input class="prt-input" type="password" name="new_password" placeholder="Leave blank to keep current password">
                        </div>
                        <div class="prt-form-group">
                            <label class="prt-label">Confirm Password</label>
                            <input class="prt-input" type="password" name="confirm_password" placeholder="Re-enter new password">
                        </div>
                    </div>
                    <button type="submit" name="save_profile" class="prt-btn prt-btn-primary"><i class="fas fa-save"></i> Save Changes</button>
                </div>
            </div>
        </form>
    </div>
