<?php
// ============================================================
// lecturer/settings.php — Account Settings
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    ...
    if (!$current || !$new || !$confirm) {
        ...
        mysqli_query($conn,"UPDATE lecturers SET password='$hash' WHERE id=$id");
    ...
    <div class="prt-panel">
        ...
        <div class="prt-panel-body">
            ...
            <div class="setting-row">
                <div class="sr-info">
                    <h4>Subject</h4>
                    <p><?php echo htmlspecialchars($account['subject_specialization'] ?? 'N/A'); ?></p>
                </div>
